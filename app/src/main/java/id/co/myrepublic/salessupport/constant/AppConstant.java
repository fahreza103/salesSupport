...
public interface AppConstant {
    ...
    public static final String VALIDATE_ORDER_API_URL = BASE_API_URL+"/order/new_order_items_validation";
    ...
    public static final String SESSION_ORDER_DATA_KEY = "sessionOrderData";
